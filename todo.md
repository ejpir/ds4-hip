...
- Added a one-command max-performance/full-copy server preset:
  ...
  - expands to the current best prefill flags: raw/mixed attention, Q8 batch shared-X with RPB32/block16 plus grouped attn_output_a tile32, Q2 MoE expert-batch with RPB16 shared-X/shared-mid.
